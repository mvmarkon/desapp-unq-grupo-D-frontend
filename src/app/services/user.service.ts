...
export class UserService {
  ...
  getUsers(): Observable<User[]> {
    ...
    .pipe(
      // tap(users => this.log('Success', `fetched users`)),
  ...
  getUser(id: number) {
    ...
    return this.http.get<User>(url).pipe(
      // tap(_ => this.log('Success', `fetched user id=${id}`)),
  ...
  updateUser(user: User): Observable<any> {
    ...
    return this.http.put(url, user, httpOptions).pipe(
      tap(_ => this.log('Success', `updated User id=${user.cuil}`)),
  ...
  chargeCredit(currentAccount: CurrentAccount, credit: number): Observable<any> {
    ...
    return this.http.put(url, currentAccount, httpOptions).pipe(
      tap(_ => this.log('Success', `updated CurrentAccount id=${credit}`)),
      catchError(this.handleError<any>(''))
    );
  }
  ...
  getCurrentAccount(cuil: number) {
    ...
    return this.http.get<CurrentAccount>(url).pipe(
      // tap(_ => this.log('Success', `fetched currentAccount cuil=${cuil}`)),
